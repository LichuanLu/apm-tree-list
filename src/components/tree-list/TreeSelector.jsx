...
export default class TreeSelector extends React.PureComponent {
    ...
    render() {
        ...
        <Modal visible={this.state.showTreeListModal} className="amp-full-selector-modal">
          ...
          <TreeList current={current} fetchChildren={fetchChildren} storageKeyPrefix={storageKeyPrefix} value={value} onChange={(val) => { this.onChange(val); }} showSelect multipleSelect={multipleSelect}/>
        </Modal>
      </div>);
    }
}
