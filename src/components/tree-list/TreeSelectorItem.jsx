...
export default class TreeSelectorItem extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            selItem: [],
    ...
    render() {
        ...
        return (<Item className={wrapCls} style={style}>
        <Flex justify="between">
          <Checkbox className={`${prefixCls}-checkbox`} checked={selected(showSelect, sel, rowData)} onChange={onChange}/>
          ...
          {rowData.children ?
            ...
            :
                <Button className="next-level-btn" type="ghost" inline icon="right" style={{ color: '#272727' }}/>}

        </Flex>
      </Item>);
    }
}
TreeSelectorItem.defaultProps = {
